...
namespace PokemonGo.RocketAPI.Console
{
	public partial class Config : Form
    {
		...
		private void PremiumStuff()
		{
			license.Text = Globals.licensed ? "License: Premium" : "License: Free";
			licensedto.Text = "Licensed to: " + (Globals.licensed ? Auth.user(Globals.licensekey) : "Everyone");
			...
			if (!Globals.licensed)
			{
				...
				chkAutoIncubate.Enabled = false;
				checkBox4.Checked = false;
				checkBox6.Checked = false;
			}
			else
			{
				antiban.Checked = true;
			}
		}
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!true)
            {
                ...
                Globals.speed = double.Parse("15".Replace(',', '.'), cords, NumberFormatInfo.InvariantInfo);
            ...
            if (!true)
            {
                ...
                Globals.radius = int.Parse("10000");
            ...
            Globals.gerNames = false;
            Globals.useincense = checkBox9.Checked;
            Globals.pokeList = false;
        ...
        private void germanpokes_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
			Globals.useBasicIncubators = true;
        }
